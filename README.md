...
| BTIP-103 |       [Support fetching SP address from the proposal contract for file uploads](BTIPS/BTIP-103.md)        |   <cody.meng@tron.network>    | core protocal |                   | Last Call |
| BTIP-104 |                          [Support renewal for uploaded files](BTIPS/BTIP-104.md)                          |   <cody.meng@tron.network>    | core protocal |                   | Last Call |
| BTIP-105 |                         [Introduce proxy mode for file upload](BTIPS/BTIP-105.md)                         |   <cody.meng@tron.network>    | core protocal |                   | Last Call |
